...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    utilidadTotal: 71_747_147,
    ingresos: 117_606_450,
    inversion: 45_859_303,
    bloques: [
      {
        ...
        lineas: [
          ...
          { label: 'Costo de obra por unidad ($8,000/m²)', value: mxn(520_000) },
          { label: 'Costo terreno por unidad', value: mxn(181_334) },
          { label: 'Indirectos 15%', value: mxn(105_200) },
          { label: 'Costo total por unidad', value: mxn(806_534) },
          { label: 'Precio de venta por departamento', value: mxn(2_375_000) },
          { label: 'Venta total', value: mxn(85_500_000) },
          { label: 'Inversión total', value: mxn(29_035_224) },
          { label: 'Utilidad proyectada', value: mxn(56_464_776), strong: true },
          { label: 'Utilidad por unidad', value: mxn(1_568_466) },
        ],
      },
    ],
  },
  {
    ...
    utilidadTotal: 294_898_507,
    ingresos: 481_606_450,
    inversion: 186_707_943,
    bloques: [
      {
        ...
        lineas: [
          ...
          { label: 'Gastos operativos 15%', value: mxn(114_822) },
          { label: 'Costo total por unidad', value: mxn(880_304) },
          { label: 'Precio de venta por departamento', value: mxn(2_275_000) },
          { label: 'Venta total', value: mxn(364_000_000) },
          { label: 'Inversión total', value: mxn(140_848_640) },
          { label: 'Utilidad proyectada', value: mxn(223_151_360), strong: true },
          { label: 'Utilidad por unidad', value: mxn(1_394_696) },
        ],
      },
    ],
  },
...
export const risks = [
  ...
  },
  {
    ...
    descripcion: 'El paramétrico de obra ($8,000/m² más indirectos) debe validarse con presupuesto ejecutivo.',
...
export const faqs = [
  ...
  },
  {
    ...
    a: 'Depende de la ruta de ejecución. El modelo preliminar estima una utilidad de $19.0 MDP en el escenario conservador, $71.7 MDP en el base y $294.9 MDP en el expansivo. Son proyecciones, no rendimientos garantizados.',
  },
  {
